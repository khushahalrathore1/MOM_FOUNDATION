...
<form class="row g-3 needs-validation" method="post" action="donor_managment_form_action.php" novalidate>
  ...
  <div class="card">
    ...
    <div class="card-body bg-body-tertiary">
      <div class="row">
        ...
        <div class="col-md-2" id="occupationDiv" style="display:none;">
          <label class="form-label">Occupation</label>
          <input class="form-control" name="occupation" type="text" />
        </div>
        <div class="col-md-2">
          <label class="form-label">Date of Birth</label>
          <input class="form-control datetimepicker" id="dob" name="dob" type="text" placeholder="dd/mm/yyyy" onchange="calculateAge()" required />
      ...
      <div class="row mt-2">
        <div class="col-md-2">
          ...
          <input class="form-control datetimepicker" name="visit_date" type="text" placeholder="dd/mm/yyyy" required />
  ...
  <div class="card mt-3">
    ...
    <div class="card-body bg-body-tertiary">
      <div class="row">
        ...
        <div class="col-md-2">
          <label class="form-label">Date of Birth</label>
          <input class="form-control datetimepicker" name="memory_dob" type="text" placeholder="dd/mm/yyyy" />
        </div>
        <div class="col-md-2">
          <label class="form-label">Date of Death</label>
          <input class="form-control datetimepicker" name="memory_dod" type="text" placeholder="dd/mm/yyyy" />
        </div>
        <div class="col-md-2">
        ...
        <div class="col-md-3" id="husbandNameDiv" style="display:none;">
          ...
          <input class="form-control" name="husband_name" type="text" />
        </div>
        <div class="col-md-2" id="marriageDateDiv" style="display:none;">
        ...
        <div class="col-md-3" id="husbandOccDiv" style="display:none;">
          ...
          <input class="form-control" name="husband_occupation" type="text" />
        </div>
        <div class="col-md-2" id="livingLocationDiv" style="display:none;">
          <label class="form-label">Living in (Location)</label>
          <input class="form-control" name="living_location" type="text" />
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="card mt-3">
    <div class="card-header">
      <h5 class="mb-0 text-primary">Event Photos</h5>
    </div>
    <div class="card-body bg-body-tertiary">
      <div class="row">
        <div class="col-md-4">
          <label class="form-label">Event Photo 1</label>
          <input class="form-control" name="event_photo_first" type="file" accept="image/*" />
        </div>
        <div class="col-md-4">
          <label class="form-label">Event Photo 2 <span class="text-danger">*</span></label>
          <input class="form-control" name="event_photo_second" type="file" accept="image/*" required />
          <div class="invalid-feedback">Upload full-size photo.</div>
        </div>
        <div class="col-md-4">
          <label class="form-label">Event Photo 3 <span class="text-danger">*</span></label>
          <input class="form-control" name="event_photo_third" type="file" accept="image/*" required />
