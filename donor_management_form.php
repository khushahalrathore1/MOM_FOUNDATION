...
<body>
  ...
  <div class="card-header">
    <div class="row flex-between-end">
      <div class="col-auto align-self-center">
        <h5 class="mb-0" data-anchor="data-anchor">Donor Management Form</h5>
      </div>
      <div class="col-auto ms-auto">
        <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
          <!-- <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#donorFormTab" type="button" role="tab" aria-controls="donorFormTab" aria-selected="true" id="tab-donorFormTab">All Donor Form</button> -->
        </div>
      </div>
    </div>
  </div>
  <div class="card-body bg-body-tertiary">
    <div class="tab-content">
      <div class="tab-pane preview-tab-pane active" role="tabpanel" id="donorFormTab">
        <form class="row g-3 needs-validation" novalidate>
          ...
          <div class="col-md-4">
           ...
           <div class="col-md-4">
            ...
            <textarea class="form-control" rows="2" placeholder="Local Address"></textarea>
          </div>
           <div class="col-md-4">
          ...
          <div class="col-md-6">
            ...
            <textarea class="form-control" rows="2" placeholder="What was donated"></textarea>
          </div>
           <div class="col-md-6">
            <label class="form-label">Reason for Donating</label>
            <textarea class="form-control" rows="2" placeholder="Reason for Donating"></textarea>
          </div>
          <h5 class="text-primary">If Donated In Memory Of</h5>
          <div class="col-md-3">
