      ...
      <tbody>
        ...
        while ($row = mysqli_fetch_assoc($result)) {
          ...
          if ($row['event_photo_first']) {
            echo "<img src='uploads/".htmlspecialchars($row['event_photo_first'])."' width='50' height='50' style='border-radius:4px;margin-right:3px;'>";
          }
          if ($row['event_photo_second']) {
            echo "<img src='uploads/".htmlspecialchars($row['event_photo_second'])."' width='50' height='50' style='border-radius:4px;margin-right:3px;'>";
          }
          if ($row['event_photo_third']) {
            echo "<img src='uploads/".htmlspecialchars($row['event_photo_third'])."' width='50' height='50' style='border-radius:4px;'>";
          }
          echo "</td>";
          echo "</tr>";
        }
